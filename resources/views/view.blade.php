...
<body class="">
  <div class="wrapper " style="background-color:#1cb8b1">
    ...
    <div class="main-panel" id="main-panel">
      ...
      <!-- End Navbar -->
      <div class="panel-header panel-header-sm" style="height:50px">
      </div>
      <div class="content" >
       ...
       <a href="/backtoreport" class="btn btn-danger" role="button" style="float: right;margin-left:5px"> Cancel </a>
      <a href="/show" class="btn btn-warning" role="button" style="float: right;"> Show All Reports </a>
        <button onclick="printContent('div1')" class="btn btn-success" style="float:right;margin-right:5px">Print</button>
