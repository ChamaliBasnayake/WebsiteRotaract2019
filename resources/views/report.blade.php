...
<div class="container" style="height:700px;background-color:white;margin-top:25px" >
  <br>
              <center>
                  <h1 style="color:#0a053a">
                      Report Generation 
                  </h1>
              </center>
              <br>
...
@if(count($errors) >0)
    <div class="alert alert-warning"style=" background-color:gray"  >
    <button type="button" class="close" data-dismiss="alert">X</button>
    <ul >
        @foreach($errors->all() as $error)
            <li style="font-weight:bold;color:white">{{ $error }}</li>
        @endforeach
    </ul>
    </div>
@endif
    ...
    @endif
                      <form class="form-horizontal" method="post" action="{{url('/generatereport')}}" enctype="multipart/form-data">

                        {{ csrf_field() }}

                        <div class="form-group">

                            <p class><label><font color="black" size="5">Title Of The Report: </font></label></p>

                                <input type="text" class="form-control" name="title" placeholder="Enter the project title here..." autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <p class><label><font color="black" size="5">Description : </font></label></p>

                                <textarea class="form-control" name="description" rows="30" placeholder="Enter the project description here..."></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <p class><label><font color="black" size="5">Image : </font></label></p>
                                <input type="text" class="form-control" name="image" placeholder="Upload your images to here in jpg , png , gif format...">
                                <input required type="file" class="form-control" name="image" multiple>
                      
                        </div>
                      <br>
                        <a href="/show" class="btn btn-success" role="button" style="float: right;"> Show All Reports </a>
                        <input type="submit" class="btn btn-info" value=" Generate" style="float: right;margin-right:8px">
