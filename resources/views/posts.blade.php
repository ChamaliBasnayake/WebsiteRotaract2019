...
@endif
    ...
    @endif
                      <form class="form-horizontal" method="post" action="{{url('/p2')}}" enctype="multipart/form-data"style="height:5px">
                        ...
                        <div class="form-group">
                            ...
                            <p class><label><font color="black" size="5">Files : </font></label></p>
                      ...
                      <br>
                        <a href="/showposts" class="btn btn-success" role="button" style="float: right;"> Show All Posts </a>
                        <input type="submit" class="btn btn-info" value=" Post" style="float: right;margin-right:8px">
