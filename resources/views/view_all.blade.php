...
<div class="container">
 ...
 <div>   
<h2 align="center" style="color:white;padding-top:35px;">Donated List</h2>
...
<a href="{{action('DonateController@viewdonate')}}" class="btn btn-primary" >Add New Donation</a></div>
<a href="{{action('DonateController@viewalldonate')}}" class="btn btn-success" >View Donations</a>
</div>
...
<br/>
<br/>
    <table class="table table-dark" style="margin-top:-45px;width:100%" >
        <thead >
        <tr >
            <th>
                Project Title
        ...
        @foreach($donation as $row)
            <tr class="donation_details" >
                ...
                <td style="width:235px;">
                 {{$row->item}}({{$row->itemcode}}) : ( {{$row->quantity1}} / {{$row->quantity2}} )
                </td>
            </tr>
        @endforeach
        </tbody>
