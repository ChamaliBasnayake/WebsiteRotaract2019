...
<body class="">
  <div class="wrapper " >
    <div class="sidebar" >
      ...
      <div class="sidebar-wrapper" id="sidebar-wrapper" style="background-color:#002230;width:">
        <ul class="nav">
    ...
    <div class="main-panel" id="main-panel">
      ...
      <div class="content" style="background-image: url('/images/xb.jpg');width:100%">
         <div ><h1 style="padding-top:185px;color:white;font-weight:bold;text-align:center;font-size:85px"class="animated zoomIn" id="animation">Hello Welcome Back<h1></div>
          <div class="container">
