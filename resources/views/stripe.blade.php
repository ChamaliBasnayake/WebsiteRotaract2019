...
<body class="">
  <div class="wrapper "style="background-color:#002230">
    ...
    <div class="main-panel" id="main-panel">
      <!-- Navbar -->
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute" style="margin-left:1055px">
                    ...
                    <form role="form" action="{{ route('stripe.post') }}" method="post" class="require-validation"
                        ...
                        <div class='form-row row'>
                           ...
                           {{--  <div class='col-xs-12 form-group expiration required'>
                                    <label class='control-label'>Paid (Please put a tick before do the payment)</label>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <button class="btn btn-primary btn-lg btn-block" type="submit">Pay Now ($1.39)</button>
                            </div>
                        </div>
