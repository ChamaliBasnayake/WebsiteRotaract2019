  ...
  <div class="wrapper " style="background-color:#1cb8b1">
    ...
    <div class="main-panel" id="main-panel">
      ...
      <div class="panel-header panel-header-sm" style="height:0px">
       ...
       <div class="content">
<h2 align="center" style="color:white;padding-top:35px;">Uploaded Images</h2>
...
<div align="right" ><a href="{{action('PostsController@uploadimg')}}" class="btn btn-primary" style="padding-top:5px;padding-left:20px;padding-right:20px;">Upload New</a></div>

<br/>
<br/>
<font family="Georgia" size="3px" color="white">
<center>
<table class="table table-bordered" style="background-color:black;color:white;margin-top:-25px;width:550px;height:250px;">
    <tr>
