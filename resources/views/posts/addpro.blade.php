...
<body class=""style="background-color:red">
  <div class="wrapper "style="background-color:#002230">
    ...
    <div class="main-panel" id="main-panel">
      ...
      <div class="content" style="background-image: url('/images/a.jpg');padding-top:35px">
        
<div class = "container box" style="background-color:white;padding-top:" >

<center><label>Add Projects</label></center>
@if(count($errors) >0)
...
@endif
    ...
    <input type="text" name="position" class="form-control"placeholder="Enter the position"/>
    </div>
    <div class="form-group">
    <label>Title</label>
    ...
    <textarea name="body" class="form-control"placeholder="Enter the project description"></textarea>
    </div>
