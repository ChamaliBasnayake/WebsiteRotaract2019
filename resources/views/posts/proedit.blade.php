...
<div class = "container box" style="background-color:white;padding-top:25px">
...
@if($message =  Session::get('success'))
    ...
    <form  method="post" action ="{{ route('update',$pro_id->id) }}" enctype="multipart/form-data">
    ...
    <a href="/viwpro" class="btn btn-danger" role="button" style=""> Cancel </a>
    </div>
    </form>
</div>
      </div>
