...
<body class="">
 ...
 <div>   
<h2 align="center" style="color:white;padding-top:35px;">View New Project Suggestions</h2>

    @if($message =  Session::get('success'))
    <div class = "alert alert-success alert-block" style="margin-top:30px;width:950px;height:50px;">
...
<table class="table table-bordered" style="background-color:black;color:white;margin-top:-2px">
    ...
    <tr>
        ...
        <td>
        <form action="{{url('/toggle-approve')}}" method="POST" style="float:left">
       {{csrf_field()}}
        <input <?php if($row['approve'] == 1){ echo "checked" ;} ?> type="checkbox" name="approve">
        ...
        <form action="/delete/{{$row['id']}}" method="post"style="float:right;margin-left:10px;">
        {{csrf_field()}}
        @method('DELETE')
