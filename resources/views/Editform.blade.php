...
@endif
    ...
    @endif
        <form method="POST" action="{{action('EventCalendarController@update',$id)}}"> 

               {{csrf_field()}}
            {{ method_field('POST') }}
         <div class="container">
            <div class="jumbotron" style="margin-top:2px;background-color:white">
              <h3>Update Event<h3>
              <br>
              <input type="hidden" name="_method" value="POST" />

              <div class="form-group">
                   <label style="font-size:20px;color:blue">Name of the Event</label> 
                   <input type="text" class="form-control" name="title"  value="{{$events->title}}">
              </div>
           
          <div class="form-group" style="margin-top:35px">
            <label for=""style="font-size:20px;color:blue">Enter Color</label> 
            <input type="color" class="form-control" name="colour"  value="{{$events->colour}}"><br><br>
            </div>

           <div class="form-group"style="margin-top:-45px">
            <label for=""style="font-size:20px;color:blue"> Start Date of Event</label> 
            <input type="datetime-local" class="form-control" name="start_date" class="date" value="{{$events->start_date}}"><br>
           </div>
           
            <div class="form-group"style="margin-top:-25px">
            <label for=""style="font-size:20px;color:blue">End Date of Event</label> 
            <input type="datetime-local" class="form-control" name="end_date" class="date" value="{{$events->end_date}}"><br>
             </div>
      
            <!--<button type="submit" name="submit" class="btn btn-success">Update Data</button> -->
            <input type="submit" name="submit" class="btn btn-info" value="Update Event Data" />
              <a href="/editdata" class="btn btn-danger">Back</a>
            </div>
            </div>
            </form>
