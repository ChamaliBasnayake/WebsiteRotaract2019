...
<body class="">
  ...
  @endif
   ...
   <div >
     ...
     <a href="/neweventurl" class="btn btn-primary" style="margin-top:100px">Add Event</a><br>
    <a href="/editdata" class="btn btn-success" style="margin-top:30px">Edit Event</a><br>
    <a href="/deleteventurl" class="btn btn-danger " style="margin-top:30px">Delete Event</a>
   </div>
