      ...
      <div class="content" >
          ...
          <div class="text-center">
            <h1 style="color:white;padding-top:40px;margin-left:185px">
                  Submitted Reports 
                           <a href="/reportgeneration" class="btn btn-success" role="button" style="float: right;margin-top:45px"> Create a New Report </a>
              </h1>
              ...
              <div style="overflow-x:auto;">
                <table class="table" style="background-color:white;margin-top:5px">
                  ...
                  <tr >  
                      ...
                      <td>
                          <a href="/deleteReport/{{$v->id}}" class="btn btn-danger"onclick="return confirm('Are you sure you want to delete this record?')"> Delete </a>
                      </td>
