  ...
  <div class="wrapper " style="background-color:#1cb8b1">
    ...
    <div class="main-panel" id="main-panel">
      ...
      <div class="content" style="padding-top:25px" >
        <div class="container">
          <div class="jumbotron">
           <table class="table table-striped table-bored table-hover"> 
             ...
             @foreach($events as $event)
              <tbody>
                ...
                <th><a href="{{action('EventCalendarController@edit',$event['id'])}}" class="btn btn-info">
                        <i class="glyphicon glyphicon-edit"></i>Edit</a>

                </th>

                    <th>
                      <form method="POST" action="{{action('EventCalendarController@destroy',$event['id'])}}">
