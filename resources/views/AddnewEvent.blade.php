      ...
      <div class="row">
        ...
        <div class="panel panel-default">
          <div class="panel-heading" style="background: #2e6da4; color:white">
           ...
           <div class="panel-body" style="background-color:white;margin-top:25px;padding:25px;" >
           
           <h3>Add New Event</h3>
             
@if(count($errors) >0)
    <div class="alert alert-info"  style="font-weight:bold;background-color:gray"  >
...
@endif
            ...
            <form method="POST" action="{{action('EventCalendarController@store')}}"> 

   
               {{csrf_field()}}
           {{ method_field('POST') }}

            <label for="" style="color:blue">Name of the Event</label> 
            <input type="text" class="form-control" name="title" placeholder="Enter the name" /><br>

            <label for=""style="color:blue">Select Color</label> 
            <input type="color" class="form-control" name="colour" placeholder="Enter the colour" /><br><br>

            <label for=""style="color:blue">Start Date of Event</label> 
            <input type="datetime-local" class="form-control" name="start_date" class="date" placeholder="Enter Start Date" /><br>

            <label for=""style="color:blue">End Date of Event</label> 
