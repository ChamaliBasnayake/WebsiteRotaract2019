  ...
  <div class="wrapper " style="background-color:#1cb8b1">
    ...
    <div class="main-panel" id="main-panel">
      ...
      <div class="panel-header panel-header-sm" style="height:0px">
       ...
       <div class="content">
       <br/>
<div class = "container box" style="margin-top:25px;padding-top:10px;padding-bottom:15px;">
<center><label style="margin-top:15px;font-size:20px;">Send E-mail</label></center><br>
@if(count($errors) >0)
...
@endif
    ...
    @endif
    <form method="post" action="{{url('sendemail/send')}}" style="margin:25px;" >
    ...
    <a href="/mail" class="btn btn-success" style="margin-left:15px">View</a>
